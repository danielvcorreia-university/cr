...
HD_PWD='C:/Users/danie/OneDrive/Documentos/CR/PRATICAL/Countdown_timer/Countdown_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TP4_P1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TP4_P1_wrapper.tcl -notrace
