...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/Countdown_timer/Countdown_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TP4_P1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TP4_P1_wrapper.tcl
