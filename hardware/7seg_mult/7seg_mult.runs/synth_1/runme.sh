...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/7seg_mult/7seg_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TP3_P2_tl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TP3_P2_tl.tcl
