...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/7seg_mult/7seg_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TP3_P2_tl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TP3_P2_tl.tcl -notrace
