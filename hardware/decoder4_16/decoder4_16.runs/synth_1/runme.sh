...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/decoder4_16/decoder4_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4_16_tl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder4_16_tl.tcl
