...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"$ref_dir/../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/8713/hdl" \
       +incdir+"../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../DMA_ReverseEndianness.gen/sources_1/bd/mb_design/ipshared/8713/hdl"
}
