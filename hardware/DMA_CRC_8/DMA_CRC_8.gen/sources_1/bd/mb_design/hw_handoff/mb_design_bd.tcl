...
proc create_root_design { parentCell } {
  ...
  # Create instance: CRC_Cop_0, and set properties
  set CRC_Cop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:CRC_Cop:1.0 CRC_Cop_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CRC_Cop_0_M00_AXIS [get_bd_intf_pins CRC_Cop_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins CRC_Cop_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
