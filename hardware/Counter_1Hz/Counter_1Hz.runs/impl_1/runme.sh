...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/Counter_1Hz/Counter_1Hz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_1Hz_tl_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter_1Hz_tl_4.tcl -notrace
