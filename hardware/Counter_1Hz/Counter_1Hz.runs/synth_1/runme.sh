...
HD_PWD='C:/Users/danie/Documents/CR/PRATICAL/Counter_1Hz/Counter_1Hz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_1Hz_tl_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_1Hz_tl_4.tcl
