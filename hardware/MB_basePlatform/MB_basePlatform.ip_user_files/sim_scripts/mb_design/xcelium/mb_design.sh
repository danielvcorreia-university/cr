...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../MB_basePlatform.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../MB_basePlatform.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../MB_basePlatform.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../MB_basePlatform.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
