...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../CustomHardwareDisplays.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CustomHardwareDisplays.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../CustomHardwareDisplays.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../CustomHardwareDisplays.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
